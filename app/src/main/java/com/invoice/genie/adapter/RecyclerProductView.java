...
import com.invoice.genie.ProductDescription;
...
public class RecyclerProductView extends RecyclerView.Adapter<RecyclerProductView.MyViewHolder> {
    /**
     * Variables
     */
    ...
    private final String TAG = "RecyclerProductView";

    /**
     * Constructor to initialize
     */
    public RecyclerProductView(Context context, List<Inventory> inventoryList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.productsLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 ...
                 */
                helper.logD(TAG, single_inventory_name + " is clicked & now going to InventoryWithoutURL Description Screen - onBindViewHolder");
                Intent goToDetailScreen = new Intent(context, ProductDescription.class).addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
